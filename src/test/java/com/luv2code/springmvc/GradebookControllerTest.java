...
public class GradebookControllerTest {
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        student.setEmailAddress("Chad.darby@luv2_school.com");
    ...
    public void createStudentsHttpRequest() throws Exception {
        ...
        mockMvc.perform(post("/")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", hasSize(2)));
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("Chad.darby@luv2_school.com");
    ...
    @Test
    public void createValidGradeHttpRequestStudentDoesNotExistsEmptyResponse() throws Exception {
        this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
                        .param("gradeType", "math")
    ...
    @Test
    public void createValidGradeHttpRequestGradeTypeDoesNotExistsEmptyResponse() throws Exception {
        this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
    ...
    @Test
    public void deleteAValidGradeHttpRequestStudentIdDoesNotExistsEmptyResponse() throws Exception {
